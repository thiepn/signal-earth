...
export class EarthRenderer implements SceneRenderer {
  ...
  applyQuality(profile: QualityProfile): void {
    ...
    // The textured sphere is the lightweight overview surface. Regional/local
